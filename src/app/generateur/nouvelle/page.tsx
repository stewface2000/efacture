                  ...
                  >
                    ...
                    <div className="item-field-wrapper">
                      <span className="mobile-field-label">
                        {t("generateur.nouvelle.thDescription")}
                      </span>
                      <textarea
                        ...
                        placeholder={t(
                          "generateur.nouvelle.placeholderDescription"
                        )}
                    ...
                    <div className="item-field-wrapper">
                      <span className="mobile-field-label">
                        {t("generateur.nouvelle.thUnitPrice")}
                      </span>
                      <input
                        type="number"
                    ...
                    <div className="item-field-wrapper">
                      <span className="mobile-field-label">
                        {t("generateur.nouvelle.thTotalHT")}
                      </span>
                      <div
                        style={{
                          fontWeight: 700,
